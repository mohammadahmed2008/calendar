...
<html>
  ...
  <body>
    ...
    <div id="calblock"><form id="calform">
      ...
      <input type="datetime-local" id="evtstart" name="date" required/>
      <label for="end">Date End</label>
      <input type="datetime-local" id="evtend" name="date" required/>
      <label for="txt">Event</label>
      <textarea id="evttxt" name="title" required></textarea>
